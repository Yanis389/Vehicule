...
class CommentaireController
{
    ...
    public function listCommentaires($vehiculeId)
    {
        ...
        include './views/commentaires/list.php'; 
    }
    ...
    public function addCommentaire()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            header('Location: /vehicule/details?id=' . $vehiculeId);
            exit;
        }

        // Si la méthode n'est pas POST, on affiche le formulaire pour ajouter un commentaire
        include './views/commentaires/create.php'; // Formulaire d'ajout de commentaire
    }
    ...
    public function deleteCommentaire($id)
    {
        ...
        header('Location: /vehicule/details?id=' . $commentaire->getIdVehicule());
        exit;
    }
}
?>
